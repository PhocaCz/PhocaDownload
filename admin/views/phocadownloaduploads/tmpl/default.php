...
echo '<th class="ph-count">'.Text::_('COM_PHOCADOWNLOAD_COUNT_USER_FILES_APPROVED').'</th>'."\n";
echo '<th class="ph-count">'.Text::_('COM_PHOCADOWNLOAD_COUNT_USER_FILES_NOT_APPROVED').'</th>'."\n";
